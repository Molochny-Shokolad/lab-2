...
String SendHTML(uint8_t led1stat,uint8_t led2stat){
    ...
    ptr +="<title>Управление светодиодом даже</title>\n";
    ...
    ptr +=".button-off:active {background-color: #00FFFF;}\n";
    ptr +="p {font-size: 14px;color: #888;margin-bottom: 10px;}\n";
    ptr +="</style>\n";
    ptr +="</head>\n";
    ptr +="<body>\n";
    ptr +="<h1>ESP32 Веб сервер Молочный шоколад</h1>\n";
